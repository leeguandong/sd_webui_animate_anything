...
from models.common import tensor_to_vae_latent, DDPM_forward
...
class AnimateController:
    def __init__(self, pretrained_model_path: str, validation_data, output_dir, motion_mask=False,
...
def ui(controller):
    with gr.Blocks(css=css) as animateanything_interface:
        gr.HTML(
        ...
        create_example(
            [
                ['example/pig0.jpg', 'example/pig0.mp4', 'pigs are talking', '512', 3],
                ['example/barbie2.jpg', 'example/barbie2.mp4', 'a girl is talking', '512', 4],
            ],

        )

    return animateanything_interface
...
def on_ui_tabs():
    ...
    animateanything_interface = ui(controller)
    return [(animateanything_interface), "AnimateAnything", "AnimateAnything"]
